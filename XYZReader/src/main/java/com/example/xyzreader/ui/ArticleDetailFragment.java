...
public class ArticleDetailFragment
    ...
    private CollapsingToolbarLayout mTitleView;
    ...
    public View onCreateView (LayoutInflater inflater, ViewGroup container,
        ...
        mRootView = inflater.inflate( R.layout.fragment_detail_coord, container, false );
        mScrollView = (NestedScrollView) mRootView.findViewById( R.id.scrollview );
        mPhotoView = (ImageView) mRootView.findViewById( R.id.toolbar_image );
        mTitleView = (CollapsingToolbarLayout) mRootView.findViewById( R.id.toolbar );
        mTitleView.setExpandedTitleColor( Color.TRANSPARENT );
        ...
        mToolbar = (Toolbar) mRootView.findViewById( R.id.toolbar_text );

        ( (AppCompatActivity) getActivity() ).setSupportActionBar( mToolbar );

        // Fixed up button not working after upgrading AppCompat to 23.2.0
